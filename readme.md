...
Playing around with **web component** development using [stencil.js](https://stenciljs.com/) and the [Punk API](https://punkapi.com/) : a widget for Brewdog beer food pairing.
...
## Demo
[See live demo](https://caguy.github.io/brewdog-widget/)
